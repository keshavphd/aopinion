...
const handleSetContact = ()=>{
  ...
  return (
    <div className="z-40 p-3 mt-16 rounded-2xl lg:mt-0 bg-neutral-100">
...
<button onClick={handleSetContact}><GrEdit /></button>
        ...
        <div className="flex items-center justify-between w-full gap-1 p-4 shadow-md rounded-2xl bg-cyan-200">
            <div className="flex flex-col">
              ...
              <h1 className="text-3xl font-bold">365pts</h1>
        ...
        <div className="flex items-center justify-between w-full gap-1 p-4 shadow-md rounded-2xl bg-cyan-200">
            <div className="flex flex-col">
              ...
              <h1 className="text-3xl font-bold">10 / 19</h1>
          ...
          <div className="flex items-center justify-between w-full gap-1 p-4 shadow-md rounded-2xl bg-cyan-200">
            <div className="flex flex-col">
              <p className="text-sm font-semibold">DISQUALIFIED SURVEYS</p>
              <h1 className="text-3xl font-bold">0</h1>
